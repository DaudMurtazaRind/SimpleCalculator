...
def buttonequal():
    ...
    e.delete(0, END)
    if operation == 'add':
        e.insert(0, float(s_num) + f_num)
    elif operation == 'multiply':
        e.insert(0, float(s_num) * f_num)
    elif operation == 'subtract':
        e.insert(0, float(s_num) - f_num)
    elif operation == 'divide':
        e.insert(0, f_num / float(s_num))
...
button_subract = Button(root, text='-', padx=40, pady=20, command=buttonsubtract)
button_divide = Button(root, text='/', padx=40, pady=20, command=buttondivide)
button_equal = Button(root, text='=', padx=88, pady=20, command=buttonequal)
